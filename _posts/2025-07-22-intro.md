...
**[OWASP (Open Web Application Security Project)](https://owasp.org/www-project-top-ten/)** is a non-profit organization dedicated to improving software security. One of its most influential projects is the OWASP Top 10, a regularly updated list of the most pressing security risks facing web applications. The list helps developers create safer software by outlining a standard set of security risks affecting web applications. In each new edition, OWASP highlights emerging threats and updates the best practices to mitigate these risks.

With the increasing use of AI and emerging security challenges, OWASP developed a new set of guidelines in 2023 to address unique security concerns posed by AI applications. OWASP frequently releases new versions of the Top 10 for LLMs detailing standards for working securely with AI.
...
Resource: [OWASP Top 10 for LLM](https://owasp.org/www-project-top-10-for-large-language-model-applications/assets/PDF/OWASP-Top-10-for-LLMs-v2025.pdf)

<br>

## Lab Objective

You are a developer at a bank, and your manager has asked you to explore building a secure AI chatbot to keep up with the surge in AI. In this lab, you will build an AI-powered chatbot using AWS Bedrock. You will identify potential security risks based on the OWASP Top 10 for LLMs and implement mitigation strategies to ensure secure usage of the AI application.
